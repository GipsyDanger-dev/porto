          ...
          <div className="flex items-center gap-5">
            ...
            {project.githubUrl && (
              <a
                ...
                onMouseEnter={e => { e.currentTarget.style.color = 'var(--secondary)'; e.currentTarget.style.borderColor = 'var(--secondary)'; e.currentTarget.style.background = 'rgba(242,100,15,0.06)'; }}
